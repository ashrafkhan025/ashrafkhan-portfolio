...
const Hero = ({darkMode}) => {
    const socialIcons = [
        { icon: leetcode, alt: 'Leetcode', link: 'https://leetcode.com/u/ashrafkhan25/' },
        { icon: linkedin, alt: ' LinkedIn' , link: 'https://www.linkedin.com/in/ashrafkhan025/' },
        { icon: github, alt: 'Github' , link: 'https://github.com/ashrafkhan025' },
        { icon: youtube, alt: 'Youtube' , link: 'https://github.com/ashrafkhan025' },
    ]
  ...
  return (
    <div className='relative overflow-hidden min-h-screen flex flex-col'>
        ...
        className='body-font z-10'>
            ...
            py-12 lg:py-14 flex-col lg:flex-row items-center justify-between lg:mt14 mt-14'>
                ...
                lg:items-start text-center lg:text-left mb-12 lg:mb-0'>
                    ...
                    <h1 className={`title-font text-3xl sm:text-4xl
                        ...
                        <p className={`mb-6 sm:mb-8leading-relaxed max-w-md
                            sm:max-w-lg ${theme.textSecondary}`}
                            data-aos='fade-up'
                            data-aos-delay='600'>
                             <p className='text-2xl'>
                                 I'm a passionate Full Stack MERN Developer with experience in building modern, scalable, and responsive web applications. 
                                I specialize in technologies like React.js, Node.js, Express, and MongoDB, and enjoy creating seamless user experiences 
                ...
                <div className='lg:w-1/2 w-full max-w-md lg:max-w-lg mt-8
                         ...
                         >
                            ...
                            <div className='relaive overflow-hidden'>
                                 </div>
                                <img
                                src={hero}
                                alt='Hero Image'
                                ...
                                <img 
                                src={hi} alt="Hi icon"
                                className='absolute top-4 sm:top-4 left-12
