...
const About = ({ darkMode }) => {
    return (
        <section 
         id="about" className={`min-h-screen overflow-hidden flex 
    items-center justify-center px-4 sm:px-6 ${darkMode ? 'bg-gray-900' : 'gb-gray-50'
            }`}>
        ...
        gap-8 sm:gap-12 items-center'>
            ...
            lg:order-2 '>
                    ...
                    <p className={`text-sm sm:text-base lg:text-lg 
                        ...
                        data-aos="fade-up"
                        data-aos-delay="500">
                         I'm a passionate MERN Stack Developer with a strong interest in building modern, scalable, and user-friendly web applications. 
  I work with technologies like React.js, Node.js, Express, and MongoDB to create full-stack solutions that are both efficient and reliable.

  I enjoy turning ideas into real-world projects and solving complex problems through clean and optimized code. 
  I have experience working on dynamic web applications, implementing responsive designs, and developing secure backend systems.

  Apart from coding, I am always eager to learn new technologies and improve my skills. 
  My goal is to grow as a developer and contribute to impactful projects that deliver great user experiences and real value.
                    </p>
                    <div
                        ...
                        <div
                          ...
                          border-orange-500
                                    ...
                                    py-2 px-4 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)]
